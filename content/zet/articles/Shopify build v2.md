...
author:
  - Radek Padrta
title: Shopify build v2 - currency / structure
date: 2024-09-21
description: 
tags:
  - Home Business
...
Currency selector
After we built a language selector, I also wanted a currency selector. It should be good to have the option to send packages anywhere, and people don’t want to see everything in Czech currency. We built markets in Shopify. I divided it into three pillars:
...
We will have two pillars of products. Each pillar has its own collections. And when you click the collections, you will see products of each collection. It’s maybe a lot for customers.. maybe you need to give them a lot of options that they can choose from on the main page.
